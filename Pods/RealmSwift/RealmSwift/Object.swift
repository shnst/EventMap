...
/**
 ...
 ```swift
 class Dog: Object {
     @objc @objc dynamic var name: String = ""
     @objc @objc dynamic var adopted: Bool = false
 ...
 All property types except for `List` and `RealmOptional` *must* be declared as `@objc @objc dynamic var`. `List` and
